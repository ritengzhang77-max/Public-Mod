...
1. **唤醒势力**：八王之乱里多数派系开局是“休眠”的，送它一座城就会活过来；384 年的 19 家开局势力由此就位。
...
6. **成婚**：史实上的夫妻开局即成婚（见下）。
7. **外交**：11 组附庸、6 组战争（见 [factions.md](factions.md)）。
...
| 回合 | 年份 | 事件 |
|---:|---|---|
| 1 | 384 夏 | 世界布置完毕：6 组战争、11 组附庸、3 对夫妻成婚、各家封官；「群雄思奋」「就食于敌」开始计时 |
